<template>
  ...
  >
    <template v-if="type.toLowerCase() === 'radio'">
      <a-radio v-for="dictItem in dictItems" :key="dictItem.id" :value="dictItem.value">
        {{ dictItem.name }}
      </a-radio>
    </template>
    <template v-if="type.toLowerCase() === 'button'">
      <a-radio-button v-for="dictItem in dictItems" :key="dictItem.id" :value="dictItem.value">
        {{ dictItem.name }}
      </a-radio-button>
    </template>
  </a-radio-group>
